...
namespace Day14SpaceStoichiometry.Tests
{
    public class ReactionsTests
    {
        [Theory]
        [ClassData(typeof(ReactionsOresCalculationTestData))]
        public void ReactionsCalculatesOresCorrectly(string input, BigInteger expectedOutput)
        {
            //Arrange
            Reactions reactions = new Reactions(InputParser.Parse(input));

            //Act
            var actualOutput = reactions.GetNumberOfOresNeededForFuel();
        ...
        [Theory]
        [ClassData(typeof(ReactionsFuelCalculationTestData))]
        public void ReactionsCalculatesFuelCorrectly(string input, BigInteger expectedOutput)
        {
            //Arrange
            Reactions reactions = new Reactions(InputParser.Parse(input));

            //Act
            var actualOutput = reactions.GetFuelQuantityForTrillionOre();
    ...
    public class ReactionsOresCalculationTestData : IEnumerable<object[]>
    {
...
4 PFSQF, 4 DMGF => 3 MRQJ",
    ...
    public class ReactionsFuelCalculationTestData : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
