...
{
    public class CrossedWiresDistanceCalculatorTests
    {
        [Theory]
        [ClassData(typeof(CrossedWiresDistanceCalculatorTestData))]
        public void CrossedWiresDistanceCalculatorWorks(string commands, int expectedDistance)
        {
            //Arrange
            CrossedWiresDistanceCalculator crossedWiresDistanceCalculator = new CrossedWiresDistanceCalculator(commands);

            //Act
            var actualDistance = crossedWiresDistanceCalculator.CalculateDistance();
    ...
    public class CrossedWiresDistanceCalculatorTestData : IEnumerable<object[]>
    {
