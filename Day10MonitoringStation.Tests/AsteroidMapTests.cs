...
namespace Day10MonitoringStation.Tests
{
    public class AsteroidMapTests
    {
        ...
        [Theory]
        [ClassData(typeof(AsteroidMapVaporizeTestData))]
        public void AsteroidMapVaporizeWorks(string input, int asteroidNumber, string expectedAsteroidCoordinates)
        {
            //Arrange
            AsteroidMap asteroidMap = new AsteroidMap(input);

            //Act
            var actualAsteroid = asteroidMap.VaporizeAsteroids().Skip(asteroidNumber - 1).First();

            //Assert
            Assert.Equal(expectedAsteroidCoordinates, actualAsteroid.ToString());
        }
    }
...
...#..#.#......................#...............#",
    ...
    public class AsteroidMapVaporizeTestData : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
...
..#.#.....#....##", 1, "8,1"
            ...
            yield return new object[]
            {
                AsteroidMapVaporizeTestDataConstants.TestInput, 2, "12,1"
            };

            yield return new object[]
            {
                AsteroidMapVaporizeTestDataConstants.TestInput, 1, "11,12"
            };
            ...
            yield return new object[]
            {
                AsteroidMapVaporizeTestDataConstants.TestInput, 299, "11,1"
            };
...
...#..#.#......................#...............#",
    ...
    public static class AsteroidMapVaporizeTestDataConstants
    {
