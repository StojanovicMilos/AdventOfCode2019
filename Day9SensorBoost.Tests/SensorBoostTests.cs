...
namespace Day9SensorBoost.Tests
{
    public class SensorBoostTests
    {
        [Theory]
        [ClassData(typeof(SensorBoostOutputTestData))]
        public void SensorBoostOutputWorks(BigInteger[] initialData, InstructionResult initial, BigInteger expectedResult)
        {
            //Arrange
